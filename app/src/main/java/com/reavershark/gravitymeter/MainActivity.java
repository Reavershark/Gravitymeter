...
public class MainActivity extends Activity implements SensorEventListener {
    ...
    public TextView gravxTxtView;
    public TextView gravyTxtView;
    public TextView gravzTxtView;
    public ImageView pointerImgView;
    public ImageView centerImgView;
    ...
    public void onSensorChanged(SensorEvent event) {
        if (event.sensor.getType() == Sensor.TYPE_ACCELEROMETER && event.accuracy == SensorManager.SENSOR_STATUS_ACCURACY_MEDIUM) {
